...
if option == "Home":
    ...
    # MENAMBAHKAN KEMBALI GAMBAR DI SINI
    ...
    if data_option == "Raw Data":
        st.subheader("Raw Data (prepared_traffic_accidents.csv)")
        st.dataframe(df_raw)
    ...
    elif data_option == "Unscaled Data":
        st.subheader("Unscaled Data (prepared_data_unscaled.csv)")
        ...
        st.subheader("Scaled Data (prepared_data_scaled.csv)")
